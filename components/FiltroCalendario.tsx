...
const FiltroCalendario: React.FC<CalendarioProps> = ({
  ...
  return (
    <CalendarStrip
      style={{ height: 100, paddingTop: 15, paddingBottom: 5, marginTop: 18, marginBottom: 5 }}
      ...
      highlightDateNumberStyle={{
        color: moment(fechaSeleccionada).isSame(today, "day")
          ? "#00ce86" // fecha actual seleccionada
      ...
      customDatesStyles={[
        {
          ...
          containerStyle: {
            ...
            borderColor: "#00ce86", // Azul claro para el borde cuando no está seleccionada
          ...
          textStyle: {
            color: moment(fechaSeleccionada).isSame(today, "day")
              ...
              : "#00ce86", // Azul claro cuando la fecha actual no está seleccionada
            fontSize: 20,
            fontWeight: "bold",
          },
          textNameStyle: {
