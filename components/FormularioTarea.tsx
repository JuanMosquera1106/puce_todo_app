...
export default function FormularioTarea({
  ...
  return (
    <StyledView className="flex-1 p-5">
      ...
      <StyledView className="border border-gray-300 rounded-md my-2 p-2">
        <Picker
      ...
      <StyledView className="my-2">
        <StyledText>
          Fecha de Vencimiento: {tareaFechaVencimiento || "No seleccionada"}
        </StyledText>
      </StyledView>
      ...
      {mostrarNotificacion && (
        ...
        >
          <StyledView className="flex-1 justify-center items-center bg-opacity-10">
            <StyledView className="bg-white p-6 border border-gray-300 rounded-lg w-4/5">
